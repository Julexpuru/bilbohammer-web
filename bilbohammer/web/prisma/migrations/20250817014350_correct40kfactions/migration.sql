/*
  ...
  - The values [ELDARS] on the enum `FaccionesW40K` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."FaccionesW40K_new" AS ENUM ('ADEPTA_SORORITAS', 'ADEPTUS_CUSTODES', 'ADEPTUS_MECHANICUS', 'AELDARI', 'ASTRA_MILITARUM', 'BLACK_TEMPLARS', 'BLOOD_ANGELS', 'CHAOS_DAEMONS', 'CHAOS_KNIGHTS', 'CHAOS_MARINES', 'DARK_ANGELS', 'DEATHWATCH', 'DEATH_GUARD', 'DRUKHARI', 'EMPERORS_CHILDREN', 'GENESTEALER_CULTS', 'GREY_KNIGHTS', 'IMPERIAL_AGENTS', 'IMPERIAL_KNIGHTS', 'LEAGUES_OF_VOTANN', 'NECRONS', 'ORKS', 'SPACE_MARINES', 'SPACE_WOLVES', 'TAU', 'THOUSAND_SONS', 'TYRANIDS', 'WORLD_EATERS');
