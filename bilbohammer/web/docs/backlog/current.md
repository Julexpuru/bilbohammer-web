...
- `BH-011 - bot de Telegram para reportar partidas` queda en prioridad P3: el flujo guiado está implementado; las pruebas reales y el pulido de textos/presentación se retomarán cuando aporte más valor.
...
- `BH-017 - filtros inclusivos de Partidas competitivas` queda cerrada tras comprobación manual satisfactoria.

## Proximas candidatas

- `BH-019` (P1): permitir noticias breves publicadas solo con hero y resumen, sin detalle vacío.
