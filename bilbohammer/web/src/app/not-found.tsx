export default function NotFound() {
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-3 px-4 py-16">
      <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[var(--muted)]">Error 404</p>
      <h1 className="text-3xl font-bold text-[var(--text)] sm:text-4xl">Página no encontrada</h1>
      <p className="text-[var(--muted)]">
        No hemos podido encontrar la página solicitada. Comprueba la URL o vuelve al inicio.
      </p>
      <div>
