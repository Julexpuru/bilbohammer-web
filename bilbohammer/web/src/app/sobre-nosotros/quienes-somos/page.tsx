    ...
    <div className="space-y-10">
      <section className="card grid gap-8 md:grid-cols-[minmax(0,1fr)_minmax(0,360px)] md:items-center">
        <div className="space-y-4">
          ...
          <p>
            Bilbohammer nace del entusiasmo de un grupo de personas que queria compartir partidas, pintura y
            proyectos de wargames sin depender de tiendas ni eventos puntuales. Hoy somos una asociacion abierta
            donde conviven ligas competitivas, campañas narrativas y quedadas para juegos de mesa y rol.
          </p>
