  ...
  async function onSubmit(e?: React.FormEvent) {
    ...
    try {
      const payload = {
        name,
        nick,
        membershipSince: memberSince || null,
        description,
              ...
              <div className="px-4 py-4 max-h-[85vh] overflow-y-auto">
                ...
                <div className="mb-4">
                  <div className="relative w-24 h-24 rounded-full overflow-hidden border border-white/10">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img
                      src={avatarDraft || profile.avatarUrl || "/assets/img/avatar_placeholder.png"}
                      alt="avatar"
                      className="w-full h-full object-cover"
                    />
                    <label className="absolute inset-0 bg-black/40 grid place-items-center cursor-pointer">
