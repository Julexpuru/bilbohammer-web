export const NOTIFICATION_PREFERENCE_DEFINITIONS = [
  ...
  },
  {
    ...
    label: "Partida cancelada",
    description: "Cuando cancelan una partida confirmada en la que participo.",
    inAppField: "matchCancelledInApp",
    emailField: "matchCancelledEmail",
    pushField: "matchCancelledPush",
  },
  {
...
export const DEFAULT_NOTIFICATION_PREFERENCES: NotificationPreferenceState = {
  ...
  matchCancelledInApp: true,
  matchCancelledEmail: false,
  matchCancelledPush: true,
